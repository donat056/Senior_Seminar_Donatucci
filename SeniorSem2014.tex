...
There are many different micro-based algorithms for a green cloud but I will choose to focus on two potential algorithms, gossip-based allocation and speed-scaling. 
